...
Simplified version using existing imports
"""
...
# Use the same imports as abstract2KG.py
import sys
sys.path.insert(0, '/home/mindrank/fuli/itext2kg')
...
class SimplePerformanceMonitor:
    """Simple performance monitor without psutil dependency"""
    ...
    def record_step(self, step_name: str, start_time: float):
        ...
        logging.info(f"[PERFORMANCE] {step_name}: {elapsed:.2f}s")
...
def process_abstract_with_monitoring(
    ...
    monitor: SimplePerformanceMonitor = None
    ...
    # Step 3: Build graph (includes entity and relation extraction)
    step_start = time.time()
